...
// ESTADO
export interface DestinosViajesStateModel {
  items: DestinoViaje[];
  loading: boolean;
  favorito: DestinoViaje;
}

export const initializeDestinosViajesStateModel = function() {
  return {
    items: [],
    loading: false,
    favorito: null
...
export function reducerDestinosViajes(state: DestinosViajesStateModel,
                                      action: DestinosViajesActions): DestinosViajesStateModel {
  switch (action.type) {
